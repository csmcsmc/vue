            ...
            <ul >
              <li v-for="data in aa">
                <div class="fj">
                  ...
                  <span class="fl">{{data.f_name}}</span>
                </div>
                <div class="zj">
                  <div class="zj_l">
                    <div class="zj_l_c">
                      <h2 v-for="abc in data.aaa">{{abc.f_name}}
                      <h5 v-for="a  in abc.aaa">
                        <a href="">{{a.f_name}}</a>|
                      </h5>
                      </h2>
                    </div>
              ...
              <div id="botton-scroll1" style="visibility: visible; overflow: hidden; position: relative; z-index: 2; left: 0px; width: 1200px;">
                <ul class="featureUL" style="margin: 0px; padding: 0px; position: relative; list-style-type: none; z-index: 1; width: 3600px; left: -2400px;">
                  <li class="featureBox" style="overflow: hidden; float: left; width: 238px; height: 228px;">
                    <div class="box">
                      <div class="h_icon"><img width="50" height="50" src="/static/images/hot.png">
                      </div>
                      <div class="imgbg">
                        <a href="javascript:void(0)"><img width="160" height="136" src="/static/images/hot1.jpg"></a>
                      </div>
                      <div class="name">
                  ...
                  <li class="featureBox" style="overflow: hidden; float: left; width: 238px; height: 228px;">
                    <div class="box">
                      ...
                      <div class="imgbg">
                        <a href="javascript:void(0)"><img width="160" height="136" src="/static/images/hot2.jpg"></a>
                      </div>
                      <div class="name">
                        <a href="javascript:void(0)">
                          <h2>iphone 6S</h2>
                  ...
                  <li class="featureBox" style="overflow: hidden; float: left; width: 238px; height: 228px;">
                    <div class="box">
                      ...
                      <div class="imgbg">
                        <a href="javascript:void(0)"><img width="160" height="136" src="/static/images/hot3.jpg"></a>
                      </div>
                      <div class="name">
                        <a href="javascript:void(0)">
                          <h2>倩碧特惠组合套装</h2>
                  ...
                  <li class="featureBox" style="overflow: hidden; float: left; width: 238px; height: 228px;">
                    <div class="box">
                      ...
                      <div class="imgbg">
                        <a href="javascript:void(0)"><img width="160" height="136" src="/static/images/hot4.jpg"></a>
                      </div>
                      <div class="name">
                        <a href="javascript:void(0)">
                          <h2>品利特级橄榄油</h2>
...
<span v-for="(k,v) in info" >
  <span v-for="(aa,va) in k">
      <div class="i_t mar_10">
        <span class="fl">{{va}}</span>
      ...
      <div class="content">
        ...
        <div class="fresh_mid">
          ...
          <ul >
            <li v-for=" as in aa">
              <div class="name"><a href="#">{{as.name}}</a></div>
              <div class="price">
                <font>￥<span>198.00</span></font> &nbsp; 26R{{as.gid}}
              </div>

              <div class="img">
                  <router-link :to="{path:'Product',query:{id:as.gid}}">
                <img src="/static/images/fre_1.jpg" width="185" height="155" />
              </router-link></div>
            </li>
      ...
      <!-- Begin 广告 Begin -->
      <div class="content mar_20">
        <img width="1200" height="110" src="/static/images/mban_1.jpg">
      </div>
      <!-- End 广告 End -->
    </span>
</span>
