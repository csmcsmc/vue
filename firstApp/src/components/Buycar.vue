...
<!--      &lt;!&ndash;Begin 银行卡支付 Begin &ndash;&gt;-->
      ...
      <div class="warning">
        <table border="0" style="width:1000px; text-align:center;" cellspacing="0" cellpadding="0">
          <tr height="35">
            <td style="font-size:18px;">
              感谢您在本店购物！您的订单已提交成功，请记住您的订单号: {{o_id}}
            </td>
          </tr>
          <tr>
            <td style="font-size:14px; font-family:'宋体'; padding:10px 0 20px 0; border-bottom:1px solid #b6b6b6;">
              支付时间为: {{order_time}}； &nbsp; &nbsp;您选定的支付方式为: <font color="#ff4e00">银行卡</font>； &nbsp; &nbsp;您的应付款金额为: ￥{{total_price}}
            </td>
          </tr>
          <tr>
            <td style="padding:20px 0 30px 0; font-family:'宋体';">
...
<script>
    export default {
        ...
        mounted() {
            ...
            this.order_time=this.$route.query.order_time;
        }
    }
</script>
